...
<?php $args = array( 'numberposts' => 5, 'order'=> 'DESC', 'orderby' => 'date' ); $postslist = get_posts( $args ); foreach ($postslist as $post) :  setup_postdata($post); ?>
...
<?php $args = array( 'numberposts' => 999, 'order'=> 'DESC', 'orderby' => 'date' ); $postslist = get_posts( $args ); foreach ($postslist as $post) :  setup_postdata($post); ?>
                <div class="archive-story">
                    <a class="archive-link" href="<?php the_permalink() ?>"></a>
                    <div class="archive-image" style="display: none;"></div>
                    <div class="archive-meta">
                        <div class="archive-headline"><?php the_title(); ?></div>
                        <div class="archive-subheadline"><?php echo get_post_meta ( $post->ID, 'strapline', true ) ; ?></div>
                    </div>
